...
def enviar_mensagens():
    ...
    # Verificar se o arquivo está anexado
    if not caminho_excel.is_file():
        label_status.configure(text="Erro: Nenhum arquivo anexado", text_color="red")
        return
    ...
    try:
        ...
        for _, linha in df.iterrows():
            ...
            try:
                # Calcular o minuto para o envio da mensagem
                minuto_envio = minuto + 1
                if minuto_envio >= 60:
                    minuto_envio -= 60
                    hora += 1
                ...
                # Adicionando espera para carregar a página do WhatsApp Web
                print(f"Esperando o WhatsApp Web carregar para {nome}")
                time.sleep(20)  # Ajustar o tempo de acordo com a velocidade do sistema e da rede
...
def criar_interface():
    ...
    text_mensagem = Text(janela, wrap=tk.WORD, bg="#2b2b2b", fg="white", height=8, width=50)  # Ajustar tamanho inicial
